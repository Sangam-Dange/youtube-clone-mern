...
const Header = ({
  ...
  const handleProfileMenuClicked = () => {
    dispatch(logoutUser());
  };

  return (
    <div className="header__wrapper">
      <div className="h__logo__menu">
        <div className="burger__icon">
          <RxHamburgerMenu
            fontSize={"25px"}
            color="#fff"
            onClick={() => setCurrSideHeader(!currSideHeader)}
          />
        </div>
      ...
      {isAuthenticated ? (
        <div className="h__profile">
          <Link to={"/channel"} style={{ textDecoration: "none" }}>
            <AiOutlineVideoCameraAdd fontSize={"25px"} color="#fff" />
          </Link>
          <div className="notification">
            <p>9+</p>
            <IoMdNotificationsOutline fontSize={"25px"} color="#fff" />
          </div>
          ...
          <Avatar
            ...
            onClick={handleProfileMenuClicked}
          />
        </div>
      ) : (
        <div>
